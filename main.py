...
#read the tag lookup table into a dictionary
...
def parse_flow_logs(flow_log_path, lookup_table):
    ...
    try:
        with open(flow_log_path, 'r') as file:
            for line in file:
                try:
                    # Limit processing to prevent excessive file sizes
...
if __name__ == '__main__':
    lookup_table_path = 'input/lookup_table.txt'
    flow_log_path = 'input/flow_logs.txt'
    output_file_path = 'output/output_summary.txt'
